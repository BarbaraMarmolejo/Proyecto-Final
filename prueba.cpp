...
void interpolation(void)
{
	...
	KeyFrame[playIndex].rotIncD2 = (KeyFrame[playIndex + 1].rotBrDer - KeyFrame[playIndex].rotBrDer) / i_max_steps;
}
...
void animacion()
{
	...
	if (play)
	{
		...
		else
		{
			...
			rotBrDer += KeyFrame[playIndex].rotIncD2;
